@ContaTeste 
Feature: Testar as operacoes basicas de conta 
...
Scenario Outline: Testar saque e deposito 
	Given a conta criada para o dono "<dono>" de numero <numero> com o limite <limite> e saldo <saldo> 
