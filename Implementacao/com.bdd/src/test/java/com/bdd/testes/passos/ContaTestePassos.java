...
public class ContaTestePassos {
     ...
     @Given("^a conta criada para o dono \"(.*?)\" de numero (\\d+) com o limite (\\d+) e saldo (\\d+)$")
     ...
     @When("^o dono realiza o deposito no valor de (\\d+) na conta$")
     ...
     @Then("^o dono tem o saldo no valor de (\\d+) na conta$")
